...
parser.add_argument(
    "--fwhms", nargs="*", type=float, default=[0.1], help="Full width at half maximum for STS gaussian broadening. (eV)"
)
### ----------------------------------------------------------------------
### P - tip ratio list
parser.add_argument(
...
cp2k_grid_orb.load_restart_wfn_file(args.wfn_file, emin=sel_emin, emax=sel_emax, n_occ=args.n_homo, n_virt=args.n_lumo)
