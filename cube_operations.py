...
from cp2k_spm_tools import cube, cube_utils

parser = argparse.ArgumentParser(description="Operations on gaussian cube files.")

parser.add_argument("cubes", metavar="FILENAME", nargs="+", help="Gaussian cube files.")

parser.add_argument(
    "operations", metavar="OP", type=str, help="Operations to apply to each cube. Enclose in quotation marks."
)
...
parser.add_argument("--skip_result_cube", action="store_true", help=("Don't write the result cube."))
parser.add_argument(
    "--add_artif_core",
    action="store_true",
